Pod::Spec.new do |s|
  ...
  s.description           = <<-DESC
			    Framework for selecting date in Persian Calendar.
                            Written in Swift.
                            DESC
  s.homepage              = 'https://github.com/omidgolparvar/IDPersianDatePicker'
  s.license               = { :type => 'MIT', :file => 'LICENSE.md' }
  s.author                = { 'Omid Golparvar' => 'iGolparvar@gmail.com' }
  s.source                = { :git => "https://github.com/omidgolparvar/IDPersianDatePicker.git", :tag => s.version.to_s }
  s.swift_version         = '4.2'
  s.platform              = :ios, '10.0'
  s.requires_arc          = true
